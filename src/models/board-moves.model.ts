...
export namespace BoardMovesModel {
  ...
  export function validMoves(board: BoardModel, args: ValidMovesArgs): BoardValidMove[] {
    ...
    for (const possibleMove of possibleMoves) {
      ...
      const keepMove = (possibleMove.fromPiece.side === PieceSide.P1 ? !nextBoard.gameState.p1Check : !nextBoard.gameState.p2Check);
      if (keepMove) {
  ...
  function possibleMovesPawn(board: BoardModel, args: PossibleMovesInternalArgs): BoardPossibleMove[] {
    ...
    const codeMove1Ahead = new CodeMove(0, (args.piece.side === PieceSide.P1 ? 1 : -1 ));
    ...
    if (args.piece.firstMove) {
      const codeMove2Ahead = new CodeMove(0, (args.piece.side === PieceSide.P1 ? 2 : -2 ));
    ...
    const codeMoveTopRight = new CodeMove((args.piece.side === PieceSide.P1 ? 1 : -1 ), (args.piece.side === PieceSide.P1 ? 1 : -1 ));
    ...
    const codeMoveTopLeft = new CodeMove((args.piece.side === PieceSide.P1 ? -1 : 1 ), (args.piece.side === PieceSide.P1 ? 1 : -1 ));
